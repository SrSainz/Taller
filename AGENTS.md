...
- There is no sidebar or hamburger menu. The unnamed SOBRE RUEDAS summary is the sole navigation hub. Its quick-action row opens Vehículos, Lecturas, and Facturas; the persistent tyre-logo button always returns to this summary, including from an open KPI detail.
