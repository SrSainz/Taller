...
- The Ingreso report keeps its four primary concepts visually grouped in a centered compact table: Conductor, Vehículo, Viajes, and Ingreso mensual. The driver's shift remains available as secondary text beneath the driver name instead of occupying a separate column.
