...
- Month and year are selected through compact anchored in-page menus, never full-screen or browser-native pickers. The month menu uses a small grid, the year menu uses a short list, and both close after selection, on focus leaving the control, or with Escape.
