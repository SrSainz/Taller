...
- Informes is the first top-level sidebar destination, positioned above Flota, and is the default screen for the root URL and installed PWA. It opens on the General tab; nested Gasolina opens the same reports workspace on Repostaje.
