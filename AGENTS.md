...
- The Gasolina workspace uses the selected mobile reports visual language: a teal Informes header, four compact tabs, a date-range control, rounded 2x2 KPI cards, and a monthly stacked chart. Its visible tabs are General, Gasto, Ingreso, and Conductores; Repostaje is integrated into the red Combustible KPI card and is not shown as a separate tab.
