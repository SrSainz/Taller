...
- The Gasolina workspace uses the selected mobile reports visual language: a teal Informes header, a single visible General tab, a date-range control, rounded 2x2 KPI cards, and a monthly stacked chart. Repostaje is integrated into the red Combustible KPI card, Gasto is not shown as a separate tab, and Ingreso plus Conductores are integrated into the blue Facturación KPI card.
