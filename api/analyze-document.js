...
const billingSchema = {
  ...
  required: ["company", "invoiceNumber", "issueDate", "serviceDate", "odometerKm", "date", "periodStart", "periodEnd", "taxBase", "vat", "total", "baseNetAmount", "netAmount", "promotions", "cashCollected", "tips", "connection", "points", "refunds", "tolls", "washExpenses", "otherExpenses", "trips", "concept", "maintenanceItems", "expenseCategory", "vehicle"],
};
