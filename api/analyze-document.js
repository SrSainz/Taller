...
const billingSchema = {
  ...
  required: ["company", "invoiceNumber", "issueDate", "serviceDate", "date", "periodStart", "periodEnd", "taxBase", "vat", "total", "netAmount", "cashCollected", "tips", "connection", "points", "refunds", "tolls", "washExpenses", "otherExpenses", "trips", "concept", "expenseCategory", "vehicle"],
};
